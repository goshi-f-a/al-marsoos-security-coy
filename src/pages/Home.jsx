        ...
        <div className="container flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4 shrink-0">
            <a
              ...
              className="btn btn-primary text-xs uppercase tracking-wider rounded-sm flex items-center justify-center gap-2 px-5 py-3 shadow-md"
            >
              <Phone size={14} />
              <span>Call: 0330 2051221</span>
            </a>
            <a
              href={getWhatsAppUrl('923302051221', 'Hello Al-Marsoos Security, I would like to inquire about your security services.')}
              target="_blank"
              rel="noopener noreferrer"
              className="py-3 px-5 rounded-sm bg-[#25D366] hover:bg-[#20bd5a] text-white font-bold text-xs uppercase tracking-wider flex items-center justify-center gap-2 shadow-[0_0_15px_rgba(37,211,102,0.3)] hover:shadow-[0_0_20px_rgba(37,211,102,0.5)] transition-all cursor-pointer"
            >
              ...
              <span>WhatsApp: 0330 2051221</span>
            </a>
          </div>
        </div>
      </section>
