  ...
  const handleSendMessage = (textToSend) => {
    ...
    setTimeout(() => {
      ...
      if (query.includes('quote') || query.includes('price') || query.includes('cost')) {
        responseText = 'We would love to provide a customized quote! You can fill out our interactive Quote Calculator on the Contact Us page, or speak to our Sales representative directly at 03302051221.';
      } else if (query.includes('job') || query.includes('career') || query.includes('apply') || query.includes('work') || query.includes('guard')) {
        responseText = 'We are always looking for dedicated security professionals! Please navigate to our Careers tab to apply online, or visit our training school office in Islamabad with your credentials.';
